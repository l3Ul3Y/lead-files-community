...
window = {
	...
	(
		...
		## Board
		{
			...
			"image" : "locale/newcibn/ui/serverlist.sub",
		},
		{
			"name" : "bg2", "type" : "expanded_image", "x" : 0, "y" : 0,
			"x_scale" : float(SCREEN_WIDTH) / 1024.0, "y_scale" : float(SCREEN_HEIGHT) / 768.0,
			"image" : "locale/newcibn/ui/login.sub",
		},
...
#				},
		...
		## NEWCIBN_PASSPOD
		{
			...
			"image" : "locale/newcibn/ui/login/matrix.sub",

			"children" :
			(
				{"name" : "newcibn_matrix_back", "type" : "image", "x" : 75, "y" : 95, "image" : "locale/newcibn/ui/login/pwdbar.sub", },
				{"name" : "newcibn_account_label_shadow",	"type" : "text", "x" : 21, "y" : 21, "r" : 0/255.0, "g" : 0/255.0, "b" : 0/255.0, "text" : "请输入动态密码"},
				
				
				{"name" : "newcibn_account_label",	"type" : "text", "x" : 20, "y" : 20, "r" : 255/255.0, "g" : 230/255.0, "b" : 186/255.0, "text" : "请输入动态密码"},
