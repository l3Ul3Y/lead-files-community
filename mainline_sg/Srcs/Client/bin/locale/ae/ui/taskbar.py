			...
			(
				{
					...
					"images" :
					(
						"locale/ae/ui/Mall/00.sub",
						"locale/ae/ui/Mall/01.sub",
						"locale/ae/ui/Mall/02.sub",
						"locale/ae/ui/Mall/03.sub",
						"locale/ae/ui/Mall/04.sub",
						"locale/ae/ui/Mall/05.sub",
						"locale/ae/ui/Mall/06.sub",
						"locale/ae/ui/Mall/07.sub",
						"locale/ae/ui/Mall/08.sub",
						"locale/ae/ui/Mall/09.sub",
						"locale/ae/ui/Mall/11.sub",
						"locale/ae/ui/Mall/12.sub",
						"locale/ae/ui/Mall/13.sub",
						"locale/ae/ui/Mall/14.sub",
						"locale/ae/ui/Mall/15.sub",
						"locale/ae/ui/Mall/16.sub",
					)
				},
				{
					"name" : "RampageGauge2",
