...
window = {
	...
	(
		...
		## Board
		{
			...
			"image" : "locale/vn/ui/serverlist.sub",
		},
		{
			"name" : "bg2", "type" : "expanded_image", "x" : 0, "y" : 0,
			"x_scale" : float(SCREEN_WIDTH) / 1024.0, "y_scale" : float(SCREEN_HEIGHT) / 768.0,
			"image" : "locale/vn/ui/login.sub",
		},
		...
		## LoginBoard
		{
			...
			(
				...
				},
				{
					...
					"default_image" : "locale/vn/ui/login/check_button_01.sub",
					"over_image" : "locale/vn/ui/login/check_button_02.sub",
					"down_image" : "locale/vn/ui/login/check_button_03.sub",
