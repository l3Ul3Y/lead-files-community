						...
						## 기본 능력
						{
							...
							(
								...
								{ 
									...
									"children" :
									(
										{ "name":"Status_Plus_Value", "type":"text", "x":89, "y":0, "text":"99", "r":1.0, "g":1.0, "b":1.0, "a":1.0, "text_horizontal_align":"center" },
									),
								},

								## 기본 능력 아이템 리스트
								{"name":"Status_Standard_ItemList1", "type" : "image", "x":14, "y":31, "image" : LOCALE_PATH+"label_std_item1.sub", },
								{"name":"Status_Standard_ItemList2", "type" : "image", "x":119, "y":30, "image" : LOCALE_PATH+"label_std_item2.sub", },

								## HTH
								{
									"name":"HTH_Label", "type":"window", "x":58, "y":32, "width":60, "height":20,
									"children" :
									(
								...
								## INT
								{
									"name":"INT_Label", "type":"window", "x":58, "y":32+23, "width":60, "height":20,
									"children" :
									(
								...
								## STR
								{
									"name":"STR_Label", "type":"window", "x":58, "y":32+23*2, "width":60, "height":20,
									"children" :
									(
								...
								## DEX
								{
									"name":"DEX_Label", "type":"window", "x":58, "y":32+23*3, "width":60, "height":20, 
									"children" :
									(
								...
								## HP
								{
									"name":"HEL_Label", "type":"window", "x":178, "y":32, "width":50, "height":20,
									"children" :
									(
										{ "name":"HP_Slot", "type":"image", "x":0, "y":0, "image":MIDDLE_VALUE_FILE },
										{ "name":"HP_Value", "type":"text", "x":25, "y":3, "text":"9999/9999", "r":1.0, "g":1.0, "b":1.0, "a":1.0, "text_horizontal_align":"center" },
									),
								},
								## SP
								{
									"name":"SP_Label", "type":"window", "x":178, "y":32+23, "width":50, "height":20, 
									"children" :
									(
										{ "name":"SP_Slot", "type":"image", "x":0, "y":0, "image":MIDDLE_VALUE_FILE },
										{ "name":"SP_Value", "type":"text", "x":25, "y":3, "text":"9999/9999", "r":1.0, "g":1.0, "b":1.0, "a":1.0, "text_horizontal_align":"center" },
									)
								},
								## ATT
								{
									"name":"ATT_Label", "type":"window", "x":178, "y":32+23*2, "width":50, "height":20, 
									"children" :
									(
										{ "name":"ATT_Slot", "type":"image", "x":0, "y":0, "image":MIDDLE_VALUE_FILE },
										{ "name":"ATT_Value", "type":"text", "x":30, "y":3, "text":"999", "r":1.0, "g":1.0, "b":1.0, "a":1.0, "text_horizontal_align":"center" },
									),
								},
								## DEF
								{
									"name":"DEF_Label", "type":"window", "x":178, "y":32+23*3, "width":50, "height":20, 
									"children" :
									(
										{ "name":"DEF_Slot", "type":"image", "x":0, "y":0, "image":MIDDLE_VALUE_FILE },
										{ "name":"DEF_Value", "type":"text", "x":25, "y":3, "text":"999", "r":1.0, "g":1.0, "b":1.0, "a":1.0, "text_horizontal_align":"center" },
									)
								},
							),
						},
				...
				},
				{
					...
					(

						{
							...
							(
								{ 
									"name":"Active_Skill_Point_Label", "type":"image", "x":125, "y":3, "image":LOCALE_PATH+"label_uppt.sub",
									"children" :
									(
										{ "name":"Active_Skill_Point_Value", "type":"text", "x":89, "y":0, "text":"99", "r":1.0, "g":1.0, "b":1.0, "a":1.0, "text_horizontal_align":"center" },
									),
								},
