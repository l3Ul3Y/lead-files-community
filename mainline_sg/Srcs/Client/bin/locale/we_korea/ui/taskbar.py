				...
				(
					{
						...
						"images" :
						(
							"locale/we_korea/ui/mall/00.sub",
							"locale/we_korea/ui/mall/01.sub",
							"locale/we_korea/ui/mall/02.sub",
							"locale/we_korea/ui/mall/03.sub",
							"locale/we_korea/ui/mall/04.sub",
							"locale/we_korea/ui/mall/05.sub",
							"locale/we_korea/ui/mall/06.sub",
							"locale/we_korea/ui/mall/07.sub",
							"locale/we_korea/ui/mall/08.sub",
							"locale/we_korea/ui/mall/09.sub",
							"locale/we_korea/ui/mall/11.sub",
							"locale/we_korea/ui/mall/12.sub",
							"locale/we_korea/ui/mall/13.sub",
							"locale/we_korea/ui/mall/14.sub",
							"locale/we_korea/ui/mall/15.sub",
							"locale/we_korea/ui/mall/16.sub",
						)
					},
					{
						"name" : "RampageGauge2",
