		...
		## Gauge
		{
			...
			(
				...
				},
				{
					...
					"images" :
					(
						"locale/ca/ui/mall/00.sub",
						"locale/ca/ui/mall/01.sub",
						"locale/ca/ui/mall/02.sub",
						"locale/ca/ui/mall/03.sub",
						"locale/ca/ui/mall/04.sub",
						"locale/ca/ui/mall/05.sub",
						"locale/ca/ui/mall/06.sub",
						"locale/ca/ui/mall/07.sub",
						"locale/ca/ui/mall/08.sub",
						"locale/ca/ui/mall/09.sub",
						"locale/ca/ui/mall/11.sub",
						"locale/ca/ui/mall/12.sub",
						"locale/ca/ui/mall/13.sub",
						"locale/ca/ui/mall/14.sub",
						"locale/ca/ui/mall/15.sub",
						"locale/ca/ui/mall/16.sub",
					)
				},
				{
					## 툴팁을 띄우기 위한 윈도우
