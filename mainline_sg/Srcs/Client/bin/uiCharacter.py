...
class CharacterWindow(ui.ScriptWindow):
	...
	def RefreshAlignment(self):
		...
		self.toolTipAlignment.AutoAppendTextLine(locale.TITLE_NAME_LIST[grade], gradeColor)
		self.toolTipAlignment.AutoAppendTextLine(locale.ALIGNMENT_NAME + str(point))
	...
	def __SetSkillGroupName(self, race, group):
		...
		if 0 == group:
			...
			if self.__CanUseHorseSkill():
				...
				self.skillGroupButton2.SetText(locale.SKILL_GROUP_HORSE)
				self.skillGroupButton1.Show()
				self.skillGroupButton2.Show()
